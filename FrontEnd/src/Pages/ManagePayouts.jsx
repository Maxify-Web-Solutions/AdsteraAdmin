                                            ...
                                            {item.status === "pending" ? (
                                                ...
                                                <div className="flex items-center justify-center gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-3 py-2 rounded-lg bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/20 transition"
                                                    >
                                                        <FaCheck />
                                                    </button>
                                                    ...
                                                    <button
                                                        ...
                                                        className="px-3 py-2 rounded-lg bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 transition"
                                                    >
                                                        <FaTimes />
                                                    </button>
