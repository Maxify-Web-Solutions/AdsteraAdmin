...
router.get("/admin/smart-links", authMiddleware, smartLinkController.getAllSmartLinks);
...
router.put("/edit-smartlink/:id",authMiddleware,smartLinkController.editSmartLink);
